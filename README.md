...
3. Пытаюсь сделать "эксперимент". Суть: при создании статьи меняются заголовок, аннотация и текст статьи и это должно повлиять на долю пользователей нажавших "Экспериментальную кнопку"
   ...
   2) в чеклисте перед запуском эксперимента прописано Publish and enable all Linked Feature rules, и я не прохожу эту автоматическую проверку. Почему - не знаю, поиск в инете результатов не дал.
